...
const Home = () => {
  return (
    <div>
        ...
        <div className="row">
          <div className="col-md-6 animated">
            <Animated>
              ...
              <div className="col">
                <div className="card m-5 shadow p-3 mb-5 bg-body-white rounded-5 border border-0 animated-down" style={{ width: "12rem" }}>
      ...
      <footer className="bg-light py-3 fixed-bottom animated-down">
